...
import {
  ...
  PencilIcon, ShieldIcon, CheckCircleIcon,
} from '../components/Icons';

// Inlined locally so this page doesn't depend on Icons.jsx exporting a
// camera icon (avoids "X is not exported by Icons.jsx" build failures).
